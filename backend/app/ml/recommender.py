    ...
    def recommend_cities(
        ...
        for city in candidate_cities:
            ...
            scored_candidates.append({
                ...
                "image_url": city.get("image_url") or "https://images.unsplash.com/photo-1598091383021-15ddea10925d?w=800",
                "description": city.get("description") or f"Discover the beauty and culture of {city.get('name')}.",
                "tags": city.get("tags", []),
                ...
                "popularity_score": float(city.get("popularity_score", 9.5) or 9.5),
