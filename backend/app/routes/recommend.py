...
async def get_recommended_cities(
    ...
    for c in all_cities_db:
        ...
        c_dict = {
            ...
            "image_url": c.image_url or "https://images.unsplash.com/photo-1598091383021-15ddea10925d?w=800",
            "description": c.description or f"Explore the breathtaking attractions of {c.name}, {c.country}.",
        }
