...
export default function AITripPlannerPage() {
  ...
  const GEN_STEPS = [
    "🧠 Activating Google Gemini 3.6 Flash Master Engine...",
    "🗺️ Computing Geodesic Route Coordinates & Transit Geometry...",
    "🍲 Curating Authentic Regional Delicacies & Top Food Spots...",
    "✨ Synthesizing Hour-by-Hour Master Scheduled Itinerary...",
    "⚡ Compiling Authoritative Budget & Stays Matrix..."
  ];
  ...
  useEffect(() => {
    ...
    if (generating) {
      ...
      interval = setInterval(() => {
        setGenPhase(prev => (prev + 1) % GEN_STEPS.length);
      }, 2400);
    }
        ...
        >
          {generating ? (
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <LoadingSpinner size={20} color="var(--accent)" />
              <span style={{ fontSize: "1rem", letterSpacing: "-0.2px" }}>{GEN_STEPS[genPhase]}</span>
            </div>
          ) : (
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <Sparkles size={18} />
